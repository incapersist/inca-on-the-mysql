...
int CCmdLine::SplitLine(int argc, char **argv)
{
   ...
   declaredStringType curParam; // current argv[x]
...
declaredStringType CCmdLine::GetSafeArgument(const char *pSwitch, long unsigned int iIdx, const char *pDefault)
{
   declaredStringType sRet;
...
declaredStringType CCmdLine::GetArgument(const char *pSwitch, long unsigned int iIdx)
{
